...
export const IaoPool = ({ agent, onRefreshAgent }: IaoPoolProps) => {
  ...
  return (
    <Card className="p-4 sm:p-6">
      ...
      {/* 添加IAO时间调整按钮 */}
      {isCreator && poolInfo?.startTime && Date.now() < poolInfo.startTime * 1000 && agent.iaoContractAddress && (
        <div className="mb-6 flex justify-center">
          <Button
            className="bg-[#F47521] hover:bg-[#E56411] text-white flex items-center gap-2"
