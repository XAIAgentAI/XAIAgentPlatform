...
const AgentSelector: React.FC<AgentSelectorProps> = ({ handleAgentSelect }) => {
    return (
        <div className="min-w-[135px] fixed top-24 left-[2.84vw] md:left-[1.6vw] lg:left-[20.6vw] xl:left-[26.2vw] w-[26vw] max-w-[150px] bg-stone-200 dark:bg-zinc-800 rounded-b-lg shadow-lg">
            <button
                type="button"
