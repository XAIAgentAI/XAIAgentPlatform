        ...
        <div className="mt-6 flex flex-col items-center justify-center space-y-2">
          ...
          <div className="flex compress flex-wrap justify-center gap-4 max-h-[240px] overflow-y-hidden hide-scrollbar">
            {agentDescriptions[selectedAgent]?.examples?.map((example, index) => (
              <div key={index} 
                   className="hover:bg-[rgba(22,22,22,0.05)] bg-[rgba(22,22,22,0.1)] dark:bg-[rgba(22,22,22,0.8)] dark:hover:bg-[rgba(22,22,22,0.96)] rounded-xl dark:bg-zinc-800 px-2 py-6 text-stone-700 dark:text-neutral-300 font-light text-sm text-center flex items-center justify-center w-[210px] md:w-[140px] lg:w-[180px] min-h-[5rem]"
                   onClick={async () => {
                     if (!userName) {
                       setUserStatus(false);
                       setTimeout(() => {
