                ...
                <div className="flex justify-start gap-2">
                  {isImageUrl(message.content) ? (
                    ...
                    <>
                      ...
                      <div className={`relative right-[13px] flex flex-col justify-center -top-[26px] transform bg-zinc-800 -translate-x-1/2 dark:bg-white text-background text-xs rounded py-1 px-2 whitespace-nowrap z-50 ${copiedMessageId === 'wechat-share' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
                        {t("wechatcopied")}
                      </div>                  
