...
const SideBar = ({ conversations, setIsNew, setConvid, setConversations, agentId, userName, setUserName }: SideBarProps) => {
  ...
  return (
    <>
      ...
      <div ref={sidebarRef} className={`fixed z-20 top-[114px] lg:top-[70px] xl:left-[1.6vw] 2xl:top-[70px] ${smallHidden} lg:flex flex-col lg:w-[20vw] bg-stone-200 dark:bg-zinc-800 p-4 text-white h-[calc(98vh-105px)] lg:h-[calc(97vh-88px)] rounded-md`} style={{zIndex:20}}>
