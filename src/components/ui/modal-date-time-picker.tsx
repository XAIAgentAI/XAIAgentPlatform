...
import {
  ...
  ModalPopoverContent,
  ModalPopoverTrigger,
} from "@/components/ui/modal-popover";
...
export function ModalDateTimePicker({ 
  ...
  return (
    <div className="space-y-2">
      <ModalPopover open={open} onOpenChange={disabled ? undefined : setOpen}>
        <ModalPopoverTrigger asChild>
          <Button
            variant={"outline"}
            className={cn(
        ...
        <ModalPopoverContent className="w-auto p-0 bg-white dark:bg-[#1a1a1a] rounded-lg border border-black dark:border-white border-opacity-10 dark:border-opacity-10">
