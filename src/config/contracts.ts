...
export const MAINNET_CONTRACTS: MainnetContracts = {
    ...
    USERAGENT_TOKEN: '0x16d83F6B17914a4e88436251589194CA5AC0f452', // 替换为实际地址
} as const;

// 当前环境合约地址
export const CONTRACTS = isTestnet ? TESTNET_CONTRACTS : MAINNET_CONTRACTS;

// 测试网 Stake 合约 ABI
export const TESTNET_STAKE_CONTRACT_ABI = [
    {
        "inputs": [],
...
// 主网 IAO 合约 ABI
export const MAINNET_IAO_CONTRACT_ABI = [
    {
        "inputs": [],
        "stateMutability": "nonpayable",
        "type": "constructor"
...
// 根据环境和代币类型选择当前使用的 ABI
export const getContractABI = (symbol: string = 'XAA') => {
    if (isTestnet) {
        return symbol === 'XAA' ? TESTNET_STAKE_CONTRACT_ABI : TESTNET_USERAGENT_STAKE_CONTRACT_ABI;
    }
    return symbol === 'XAA' ? MAINNET_IAO_CONTRACT_ABI : MAINNET_USERAGENT_IAO_CONTRACT_ABI;
};

// 导出合约类型
export type { TestnetContracts, MainnetContracts }; 